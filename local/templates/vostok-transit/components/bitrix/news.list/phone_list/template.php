...
<div class="header-contacts">
	<a class="header-phone header-phone-top" href="<?=$arResult['HOT_PHONE_APPLINK']?>">
		...
		<span class="mobile-hide desktop-show"><?=$arResult['HOT_PHONE']?></span>
	</a>
	...
	<div class="header-phone">
		<a href="<?=$arResult['MAIN_PHONE_WHATSAPP']?>" class="header-phone__value"><?=$arResult['MAIN_PHONE']?></a>
		<svg class="header-phone__icon" width="10" height="8" viewBox="0 0 10 8" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.866 7.5a1 1 0 0 1-1.732 0L.67 1.5A1 1 0 0 1 1.536 0h6.928a1 1 0 0 1 .866 1.5l-3.464 6z" fill="#2C3346"></path></svg>
		<div class="contacts-popup" id="contacts-popup">
			<div class="contacts-popup-list" style="--popup-contacts-count: 5">
					...
					<div class="contacts-popup-item">
						...
						<a href="<?=$arResult['MAIN_PHONE_WHATSAPP']?>" class="contacts-popup-item__phone"><?=$arResult['MAIN_PHONE']?></a>
						<div class="contacts-popup-item__text">Написать в <a href="<?=$arResult['MAIN_PHONE_WHATSAPP']?>">WhatsApp</a></div>
					</div>
					<!-- остальные номера -->
