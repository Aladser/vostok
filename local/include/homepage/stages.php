...
$APPLICATION->IncludeComponent("bitrix:news.list", "homepage-stages", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"SUBTITLE" => "Мы закрепим за Вами менеджера, который проконтролирует весь процесс от пункта 1 до пункта 7",
	),
	false
);